<?php
// Initialize $bool outside the if block to avoid the "Undefined variable" warning
if (!isset($bool)) {
    $bool = false;
}
...
if (!$bool) {
    ...
    <div class="modal fade" id="edit_candidate<?php echo $candidate_id; ?>" tabindex="-1" role="dialog"
    ...
    if (ISSET($_POST['update'])) {
        ...
        // Handle image upload
        if ($_FILES['image']['name'] != "") {  // Check if a new image was uploaded
